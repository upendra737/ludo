...
export const useSocket = () => {
  ...
  return { socket, createRoom, joinRoom, setReady, pickColor, addBot, fillBots, rollDice, moveToken, sendChat, sendEmoji, leaveRoom, restartGame };
};
...
export const SocketProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    socket.on('connect',       ()    => { setConnected(true); socket.emit('room:auth', { userId: getUserId() }); });
